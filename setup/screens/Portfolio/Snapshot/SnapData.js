...
const SnapData = () => {
  ...
  const fetchData = async () => {
    try{
      ...
      console.log(data.ClientPortfolio)
      {
    ...
    return(
      ...
      <Title style={{marginTop: 10, marginBottom: 30}}>Account #489050</Title>
        ...
        <SnapCard
          ...
          first_value={numberWithCommas(clientPortfolio.AmountInvested)}
          second_title='Current Value'
          second_value={numberWithCommas(clientPortfolio.CurrentValue)}
          title='Overall - Total'
          flag={true}
        />
        <SnapCard
      ...
      <Profile>
        ...
        {clientSuggestedPortfolio.Suggested.map((item) =>(
          <>
